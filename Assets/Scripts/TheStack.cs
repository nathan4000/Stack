...
public class TheStack : MonoBehaviour
{
    ...
    public AudioClip Notification2;
        ...
        //delete public AudioSource PlayerGunshot;
	//public AudioSource Séquence;
	//public AudioClip[] audioClipArray;
	...
	private void Update ()
	{
		...
		if (Input.GetMouseButtonDown (0))
		{
			if (PlaceTile ()) 
			{
				...
				//delete from playergunshot
				//delete SetAudio();
				//Séquence.clip = audioClipArray[Random.Range(0, audioClipArray.Length)];
				//add Random.Range
				//audioClipArray.Length
			}
			else
			{
				EndGame ();
	...
	private bool PlaceTile()
	{
		...
		if (isMovingOnX) 
		{
			...
			if (Mathf.Abs (deltaX) > ERROR_MARGIN) 
			{
				...
				//brick_impact_debris_02.PlayClipAtPoint(clip:[0], Camera.main.transform.position);
				// CUT THE TILE
